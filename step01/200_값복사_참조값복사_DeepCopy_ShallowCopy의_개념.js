...
//함수나 메소드를 호출할때 매개변수에 숫자나 문자열값을 전달하는 방식은 모두 값복사에 해당한다.


let dully_nickname = '아기공룡';

let my_nickname = dully_nickname; //값복사

dully_nickname = '초능력내친구';

//두 변수가 완전히 독립성을 갖는 것을 '깊은복사 deep copy'라고도 한다.

console.log('*******************************')
console.log(dully_nickname); //초능력내친구
