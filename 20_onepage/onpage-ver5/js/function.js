...
// arrTopVal[1] = $('article').eq(1).offset().top;
// arrTopVal[2] = $('article').eq(2).offset().top;
// arrTopVal[3] = $('article').eq(3).offset().top;
// arrTopVal[4] = $('article').eq(4).offset().top;
// arrTopVal[5] = $('article').eq(5).offset().top;
...
//view > 0 상태에서 view 값이 갖는 의미는 fotter가 노출되는 높이이다.
